        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">
                    Usuários<small> -- Gestão de Usuários</small>
                </h1>
            </div>
        </div>
        <div id="page-wrapper">
    <div class="container-fluid">
        <nav class="navbar navbar-inverse" role="navigation">
                ...
                <ul class="nav navbar-right top-nav">
                    <li>
                        {{ link_to('users/new', ' Usuário', 'class': 'fa fa-plus') }}
                    </li>
                    <li>
                        {{ link_to('users/products/1/-1', ' Produtos', 'class': 'fa fa-plug') }}
                    </li>
                    <!--<li>-->
                        <!--{{ link_to('users/packages/', ' Pacotes', 'class': 'fa fa-cube') }}-->
                    <!--</li>-->
                    <li>
